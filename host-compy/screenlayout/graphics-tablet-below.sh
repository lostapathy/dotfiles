#!/bin/sh
xrandr --output DisplayPort-2 --primary --mode 3840x2160 --pos 0x0 --rotate normal --output DisplayPort-1 --off --output DisplayPort-0 --off --output HDMI-A-0 --mode 1920x1080 --pos 960x2160 --rotate normal --output DVI-D-0 --off

# This maps the pen output to the drawing tablet.
# The 25 is the id from `xinput`
sleep 2 # Need to let the input "settle" before monkeying with the input or else this may not stick
...
i3-msg workspace "7: xournal", move workspace to output HDMI-A-0
